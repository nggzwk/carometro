...
DATASETS: dict[str, DatasetConfig] = {
    "old_portal": DatasetConfig(
        ...
        download_end_provider=lambda: datetime(2023, 6, 30),
    ...
    "cotacoes_old": DatasetConfig(
        ...
        download_base_url="https://dadosabertos.c3sl.ufpr.br/curitiba/CliqueEconomia/",
        download_start=datetime(2023, 7, 1),
        download_end_provider=lambda: datetime(2024, 12, 31),
    ...
    "cotacoes_new": DatasetConfig(
        ...
        download_start=datetime(2025, 1, 1),
