        ...
        >
          ...
          {!dismissed && (
            ...
            >
              ...
              <span
                className={`pointer-events-none absolute z-20 inline-flex w-40 flex-col items-start rounded-2xl px-4 py-2.5 text-left text-[10px] font-medium uppercase not-italic leading-tight tracking-[0.08em] transition-all duration-200 top-full right-0 mt-2 sm:top-1/2 sm:right-auto sm:left-full sm:mt-0 sm:ml-2 sm:-translate-y-1/2 ${
