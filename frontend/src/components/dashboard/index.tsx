...
export const BasketSummary: React.FC<BasketSummaryProps> = ({
  ...
  return (
    <div className="w-full max-w-md sm:max-w-xl md:max-w-3xl lg:max-w-5xl mx-auto">
      <div className="w-full pt-4 pb-2 md:pt-6 md:pb-3 text-center">
        <h2
          className="font-subheader text-3xl sm:text-4xl lg:text-5xl font-black tracking-widest relative inline-block select-none"
        ...
        <div
          className="flex justify-center items-center gap-2 mt-1 font-subheader font-black text-xl lg:text-[26px] tracking-wide select-none text-white leading-none"
