...
-- ==============================================================================
-- Create ipca_monthly_public table before 0004 functions need it
-- ==============================================================================
-- Migration 0004 creates functions that reference ipca_monthly_public,
-- but 0005 creates that table. This migration creates it early so 0004 works.
